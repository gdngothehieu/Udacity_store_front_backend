...
var currentByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var userId, order, err_4;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = parseInt(req.params.userid);
                return [4 /*yield*/, store.currentByUser(userId)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var completeByUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                userId = parseInt(req.params.userid);
                return [4 /*yield*/, store.completeByUser(userId)];
            case 1:
                order = _a.sent();
                res.json(order);
                return [3 /*break*/, 3];
...
var GetOrdersById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, orders, err_7;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                orderId = parseInt(req.params.id);
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, store.GetOrdersById(orderId)];
            case 2:
                orders = _a.sent();
                res.json(orders);
                return [3 /*break*/, 4];
...
var orderRoutes = function (app) {
    ...
    app.get("/orders/current-by-user/:userid", authorization_1.default, currentByUser);
    app.get("/orders/complete-by-user/:userid", authorization_1.default, completeByUser);
    app.post("/orders/:id/products", authorization_1.default, AddProductToOrder);
    // Get orders by order_id foreign key
    app.get("/orders/by_order_id/:id", authorization_1.default, GetOrdersById);
};
