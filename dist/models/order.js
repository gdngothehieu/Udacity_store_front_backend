        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get any orders. Error: " + err_1);
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new order " + o.id + ". Error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrdersStore.prototype.currentByUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_4 = _a.sent();
                        throw new Error("Could not find current order by user " + userId + ". Error: " + err_4);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrdersStore.prototype.completeByUser = function (userId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_5 = _a.sent();
                        throw new Error("Could not find complete orders by user " + userId + ". Error: " + err_5);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrdersStore.prototype.AddProductToOrder = function (orderId, productId, quantity) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connect.query(sql, [orderId, productId, quantity])];
                    case 2:
                        result = _a.sent();
                        connect.release();
                        return [2 /*return*/, result.rows[0]];
                    case 3:
                        err_6 = _a.sent();
                        throw new Error("Could not add product " + productId + " to order " + orderId + ". Error: " + err_6);
                    case 4: return [2 /*return*/];
                }
            });
        });
    };
    OrdersStore.prototype.GetOrdersById = function (orderId) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, connect.query(sql, [orderId])];
                    case 2:
                        result = _a.sent();
                        connect.release();
                        return [2 /*return*/, result.rows];
                    case 3:
                        err_7 = _a.sent();
                        throw new Error("Could not get orders by " + orderId + ". Error: " + err_7);
                    case 4: return [2 /*return*/];
                }
            });
        });
