...
var UsersStore = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        err_1 = _a.sent();
                        throw new Error("Could not get any users. Error: " + err_1);
    ...
    UsersStore.prototype.create = function (u) {
        return __awaiter(this, void 0, void 0, function () {
            var connect, sql, hash, result, err_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        ...
                        hash = bcrypt_1.default.hashSync(u.input_password + pepper, parseInt(saltRounds));
                        return [4 /*yield*/, connect.query(sql, [
                                u.first_name,
                                u.last_name,
                                hash,
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not add new user " + u.first_name + " " + u.last_name + ". Error: " + err_3);
                    case 4: return [2 /*return*/];
                }
            });
        });
